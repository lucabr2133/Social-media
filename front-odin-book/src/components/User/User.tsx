...
export function Users () {
  ...
  if (!users || !user || followLoading) return <>loading...</>

  return (
    <>
      <div
        className='lg:grid lg:grid-cols-[15%_85%] w-full' style={{
          display: 'grid'
        }}
      >
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor: isFollowing(userl.id, user.id)
                              ? '#e74c3c'
                              : '#4a90e2',
                            color: 'white',
                            border: 'none',
                          ...
                          onMouseEnter={(e) =>
                            (e.currentTarget.style.backgroundColor = isFollowing(userl.id, user.id)
                              ? '#c0392b'
                              : '#357abd')}
                          onMouseLeave={(e) =>
                            (e.currentTarget.style.backgroundColor = isFollowing(userl.id, user.id)
